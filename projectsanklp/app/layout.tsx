  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground font-sans">
        <a 
          href="#main-content" 
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[color:var(--accent)] focus:text-white focus:rounded-md focus:font-semibold focus:shadow-md"
        >
