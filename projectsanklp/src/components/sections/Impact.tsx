      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-24 sm:mb-32">
          {stats.map((stat, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="mb-24 sm:mb-32">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            {caseStudies.map((study, index) => (
              ...
              >
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 text-xs font-semibold text-indigo-600 dark:text-indigo-400 mb-6 self-start">
                  {study.category}
                </div>
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="pt-2 border-t border-zinc-200/60 dark:border-zinc-800/60">
                    <h5 className="text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-500 mb-1">
                      The Outcome
                    </h5>
