...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 sm:py-32 relative overflow-hidden bg-zinc-50 dark:bg-zinc-950/40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <div className="glass-panel rounded-2xl p-8 sm:p-10 shadow-sm relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-2 h-full bg-indigo-600 dark:bg-indigo-400" />
        ...
        <div className="mb-24 sm:mb-32">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-6">
          ...
          <div className="relative border-l border-zinc-200 dark:border-zinc-800 max-w-3xl mx-auto pl-6 sm:pl-8">
            {history.map((event, index) => (
              <div key={index} className="mb-10 last:mb-0 relative">
                {/* Timeline Dot */}
                <span className="absolute -left-[31px] sm:-left-[39px] top-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-white dark:bg-zinc-900 border-2 border-indigo-600 dark:border-indigo-400">
