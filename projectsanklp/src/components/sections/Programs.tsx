...
export default function Programs() {
  ...
  return (
    <section id="programs" className="py-24 sm:py-32 relative overflow-hidden bg-white">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[color:var(--accent)]/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <span className="inline-flex items-center px-3 py-1 rounded-full bg-[color:var(--card)] text-xs font-semibold text-[color:var(--accent)]">
                    {program.category}
                  </span>
                  <div className="w-10 h-10 rounded-xl bg-[color:var(--card)] text-[color:var(--accent)] flex items-center justify-center">
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-[color:var(--accent)] hover:text-[color:var(--accent)] bg-[color:var(--card)] hover:bg-[color:var(--accent)]/10 rounded-xl transition-colors w-full sm:w-auto"
                >
                  {program.ctaText}
