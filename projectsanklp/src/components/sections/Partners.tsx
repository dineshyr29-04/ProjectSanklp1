    ...
    case "ecogrid":
      return (
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold tracking-tight text-zinc-800 dark:text-zinc-200">ECOGRID</span>
        </div>
      );
    case "apex":
      return (
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold tracking-tight text-zinc-800 dark:text-zinc-200">APEX UNIV</span>
        </div>
      );
    case "veloce":
      return (
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold tracking-tight text-zinc-800 dark:text-zinc-200">VELOCE</span>
        </div>
      );
    case "impact":
      return (
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold tracking-tight text-zinc-800 dark:text-zinc-200">IMPACT FOUNDATION</span>
        </div>
      );
    default:
...
export default function Partners() {
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-zinc-50 dark:bg-zinc-950/40 border-t border-b border-zinc-200/50 dark:border-zinc-800/50">
